      ...
      try {
        ...
        <tr>
            <td colspan="2" style="text-align: center; margin-top: 0px;">
                <h4 style="font-size: 35px; color:#0061a6; font-weight: 900; margin-bottom: 10px; font-family:Verdana, Geneva, Tahoma, sans-serif; margin-top: 15px;">Review the Prices for your Rooms</h4>
                <p style="font-size: 15px; line-height: 1.2; color:#000; font-weight: 400;">Prices and delivery times are subject to review by One Point Partitions. Add sales tax if applicable.</p>
            </td>
            ...
            <td colspan="2" width="100%" style="width: 100%;">
                <div class="table_box" style="margin-top: 20px;">
                    <div style="display: flex; align-items: center; width: 100%; justify-content: space-between;  flex-wrap: wrap; box-sizing: border-box; gap: 20px;">
                        ${stalls.map(stall => `
                        <div style="padding: 10px 40px 20px; text-align:left; border: 1px solid #e4e8ef; border-radius: 15px;  width:48%; box-sizing: border-box;">
                            <div width="100%"  >
                ...
                <table width="100%" cellpadding="0" cellspacing="30" style="table-layout: fixed;">
                    <tr>
                        <td width="35%" style="width: 35%; vertical-align: top;">
                            ...
                            <h3 style="border: 1px solid #e3e8ef; padding: 10px; border-radius: 10px; font-weight: 400;      margin-top: 10px;">Untitled</h3>
                                ...
                                <div style="padding: 0px 20px 15px 20px; margin-top: 0px;">
                                    ...
                                    <p style="font-size: 15px;"><span style="color:#000; font-weight: 500;">Stall 3 </span>- Alcove Depth: 109"; Width: 60 1/2";
                                        Door: 36"; Door Swing: Right In.
                                                In.</p>
                                    <p style="display: flex; align-items: center; font-size: 15px;"><img src="${process.env.URI}/uploads/images/layout.png" alt="pic" style="width: 15px; margin-right:10px;"/><span style="color:#000; font-weight: 500;">Layout </span>- Alcove Closed, ADA, Right</p>
                                </div>
                            ...
                            <h5 style="color:#0061a6; font-size: 20px; font-weight: 600; margin-bottom: 0px;">Need this layout bigger?</h5>
